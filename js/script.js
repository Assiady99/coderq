...
const translations = {
    ...
    en: {
        ...
        about: {
            ...
            text1: 'Al-Raheeq Al-Makhtum Food Industries is a leading company in the manufacturing and distribution of high-quality food products. We believe that good food starts with natural ingredients and advanced manufacturing practices.',
        ...
        testimonials: {
            ...
            review1: '"Great products and excellent quality! Sidr honey is one of the best I\'ve tried, tastes natural and pure. I recommend everyone to try Al-Raheeq Al-Makhtum products."',
            name1: 'Ahmed Mohamed',
            city1: 'Sanaa',
            review2: '"Fast delivery service and excellent packaging. Products are 100% natural and the difference is clear in taste and quality. Thanks to Al-Raheeq Al-Makhtum team."',
            name2: 'Fatima Al-Ali',
            city2: 'Sanaa',
        ...
        footer: {
            company_name: 'Al-Raheeq Al-Makhtum',
...
function changeLanguage(lang) {
    ...
    if (lang === 'en') {
        document.title = "Alraheeq Almakhtum | Premium Food Industries";
        document.querySelector('meta[name="description"]').setAttribute("content", "Alraheeq Almakhtum - A leading company in the premium food industry, offering the best natural products of honey, juices, and dairy.");
        document.querySelector('meta[name="keywords"]').setAttribute("content", "Alraheeq Almakhtum, food, honey, juices, dairy, natural products, Yemen, food industry");
        document.querySelector('meta[property="og:title"]').setAttribute("content", "Alraheeq Almakhtum | Premium Food Industries");
        document.querySelector('meta[property="og:description"]').setAttribute("content", "Alraheeq Almakhtum - A leading company in the premium food industry.");
